...
Generate React Router pages with co-located structure (_components/, _hooks/, _types/, _utils/).

## Design System Reference

Use tokens from `.claude/skills/vite-cloudflare/docs/`:
- **COLORS.md** - Use `--color-*` tokens
- **SPACING.md** - Use `--space-*` tokens
- **ANIMATIONS.md** - Use animation classes like `fade-in`
- **COMPONENTS.md** - Follow BEM naming convention
