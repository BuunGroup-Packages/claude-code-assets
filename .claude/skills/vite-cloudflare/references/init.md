...
Create a complete Vite 6 + React 19 + Cloudflare Workers + Hono project scaffold.

Follow design system from:
```
.claude/skills/vite-cloudflare/docs/
```
...
```css
/* Design Tokens - See docs/ for full reference */
:root {
  /* Colors */
  --color-primary: #0066ff;
